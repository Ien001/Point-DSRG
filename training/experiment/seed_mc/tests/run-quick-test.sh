...
echo "UNIQUESTRING 2"
rm /media/ssd1/austin/datasets/VOC/VOCdevkit/VOC2012/DSRGOutput/*
python ../../../tools/test-ms.py --model models/model-qs_iter_40.caffemodel --images list/train_aug_id.txt --dir ${PASCAL_DIR} --output ${PASCAL_DIR}/DSRGOutput --gpu ${GPU} --smooth true

# train step 2 (retrain)
echo "UNIQUESTRING 3"
python ../../../tools/train.py --solver solver-qf.prototxt --weights models/model-qs_iter_40.caffemodel --gpu ${GPU}
echo "UNIQUESTRING 4"
rm quick_DSRG_final_output/*
python ../../../tools/test-ms-f.py --model models/model-qf_iter_100.caffemodel --images list/val_id.txt --dir ${PASCAL_DIR} --output quick_DSRG_final_output --gpu 0 --smooth true
echo "UNIQUESTRING 5"
